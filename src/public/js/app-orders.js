                                                ...
                                                <div class="">
                                                    <button class="btn-close p-4" type="button" data-bs-dismiss="modal" aria-label="Close"><span aria-hidden="true"></span></button>
                                                        <div class="p-5 my-md-4">
                                                            ...
                                                            <p class="text-muted">Total de la orden $${order.productos.reduce((acc, act) => acc + act.price * act.quantity, 0)}.-</p>
...
const renderOrders = async()=>{
    ...
    orders.forEach(order => {
        const total = order.productos.reduce((acc, act) => acc + act.price * act.quantity, 0)
